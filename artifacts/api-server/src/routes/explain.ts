...
ব্যাখ্যার ফরম্যাট (হুবহু এই label ব্যবহার করবে):
✒️ সঠিক উত্তর: '[সঠিক শব্দ]' — [শব্দটির পূর্ণ অর্থ ও ব্যাখ্যা। কেন এই শব্দটি দিয়ে প্রশ্নের বাক্যাংশটি প্রকাশ করা হয় সেটা বলো।]
✒️ অন্য অপশনগুলো যা বোঝায়: [প্রতিটি ভুল অপশনের শব্দটি আসলে কী প্রকাশ করে সেটা লেখো এই ফরম্যাটে: "শব্দ → যা বোঝায়" এবং | দিয়ে আলাদা করো]
